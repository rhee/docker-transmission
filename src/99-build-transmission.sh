...
#sh configure --prefix=/opt/transmission --enable-cli --enable-daemon --without-gtk && make && make install

#XXX need >2.0 libevent libevent-devel
#CFLAGS="-DFD_SETSIZE=32768" ???
...
# `configure' configures transmission 2.82 to adapt to many kinds of systems.
# 
...
#               C compiler flags for LIBAPPINDICATOR, overriding pkg-config
#   LIBAPPINDICATOR_LIBS
#               linker flags for LIBAPPINDICATOR, overriding pkg-config
# 
